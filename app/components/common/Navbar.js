        ...
        <nav className='max-w-[1366px] mx-auto h-[100px] flex items-center lg:justify-center justify-between p-4'>
          ...
          <ul className='hidden md:flex font-semibold text-white items-center justify-center cursor-pointer'>
            ...
            <li className='mr-5 lg:mr-8 hover:text-[#E0E21C] sm:text-[11px] md:text-[11px] lg:text-[14px] text-center'>
              <Link href='/talk-to-my-government'>Talk to my <br /> government</Link>
            </li>
            <li className='mr-5 lg:mr-8 hover:text-[#E0E21C] sm:text-[11px] lg:text-[14px] text-center'>
              <Link href='/talk-to-my-organisation'>Talk to my <br /> Organization</Link>
            </li>
            <li className='mr-5 lg:mr-8 hover:text-[#E0E21C] sm:text-[11px] lg:text-[14px] text-center'>
              <Link href='/GetLegalAssistance'>Get legal <br /> Assistance</Link>
            </li>
            <li className='mr-5 lg:mr-8 hover:text-[#E0E21C] sm:text-[11px] lg:text-[14px] text-center'>
            ...
            <li className='hover:text-[#E0E21C] sm:text-[11px] text-center flex flex-col items-center'>
              ...
              <span className='sm:text-[7px] lg:text-[10px] text-center'>Translate</span>
            </li>
          </ul>
          ...
          <div className="hidden md:flex">
            <div className='flex'>
              <Link href='/login'>
                <button className="mr-5 md:mr-2 lg:mr-8 border-2 border-[#E0E21C] text-[#E0E21C] sm:text-[11px] sm:px-2 lg:text-[13px] rounded lg:px-4 lg:py-2 sm:py-1 sm:px-1">
                  Login
                </button>
              </Link>
              <Link href='/signup'>
                <button className="bg-[#E0E21C] text-black hover:bg-white hover:text-[#E0E21C] sm:text-[11px] sm:px-2 lg:text-[13px] rounded lg:px-2 lg:py-2.5 sm:py-1.5">
                  Sign Up
                </button>
              </Link>
            </div>
          ...
          <div onClick={handleSmallerScreensNavigation} className='flex md:hidden'>
            {menuIcon ? (
              <AiOutlineClose size={25} className='text-[#E0E21C]' />
            ) : (
          ...
          {/* Small screen navbar */}
          <div className={`md:hidden absolute top-[100px] right-0 left-0 flex w-full h-screen bg-black text-white text-center ease-in duration-300 ${menuIcon ? 'left-0' : 'left-[-100%]'}`}>
